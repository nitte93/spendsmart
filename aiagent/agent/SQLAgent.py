...
from aiagent.agent.DatabaseManager import DatabaseManager
from aiagent.agent.LLMManager import LLMManager
...
class SQLAgent:
    ...
    def parse_question(self, state: dict) -> dict:
        ...
        prompt = ChatPromptTemplate.from_messages([
            ...
            For example, the column "Artist name" contains nouns relevant to the question "What are the top selling artists?",
            but the column "Artist ID" is not relevant because it does not contain a noun. 
